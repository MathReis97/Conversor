         ...
         case "Conversor de Temperatura":
            ...
            switch(menuTemperatura) {
               case "Celcius para Fahrenheit":
                  JOptionPane.showMessageDialog(null,
                     "Resultado da conversão é " + String.format("%.2f", Temperatura.celciusToFahrenheit(temperatura)));
                     break;
                  ...
                  JOptionPane.showMessageDialog(null,
                     "Resultado da conversão é " + String.format("%.2f", Temperatura.fahrenheitToKelvin(temperatura)));
                     break;

                     case "Fahrenheit para Celcius":
                  JOptionPane.showMessageDialog(null,
                     "Resultado da conversão é " + String.format("%.2f", Temperatura.fahrenheitToCelcius(temperatura)));
                     break;

                     case "Kelvin para Fahrenheit":
                  JOptionPane.showMessageDialog(null,
                     "Resultado da conversão é " + String.format("%.2f", Temperatura.kelvinToFahrenheit(temperatura)));
                     break;
